...
test=convec;
%convec=convec(:,randperm(size(convec,2)));

%%%%%%%%%%%%%%%%%%%%%%%%%%% setting %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% month=1;
% dd=month*30;  % event day
...
% 
% %%%%%
% k=2;   % number of customers in each cluster
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
clusterbin1diff=abs(clusterbaseline1-clusterevent1);
clusterbin1MAE=sum(clusterbin1diff(:))/(24*size(bin1event,2));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bin 2 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bin2diff=abs(CBL22'-bin2event);
...
clusterbin2diff=abs(clusterbaseline2-clusterevent2);
clusterbin2MAE=sum(clusterbin2diff(:))/(24*size(bin2event,2));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bin 3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bin3diff=abs(CBL33'-bin3event);
...
clusterbin3diff=abs(clusterbaseline3-clusterevent3);
clusterbin3MAE=sum(clusterbin3diff(:))/(24*size(bin3event,2));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bin 4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bin4diff=abs(CBL44'-bin4event);
...
clusterbin4diff=abs(clusterbaseline4-clusterevent4);
clusterbin4MAE=sum(clusterbin4diff(:))/(24*size(bin4event,2));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% bin 5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
bin5diff=abs(CBL55'-bin5event);
...
clusterbin5diff=abs(clusterbaseline5-clusterevent5);
